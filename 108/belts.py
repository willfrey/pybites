...
def get_total_points(belts: Mapping[str, BeltStats] = ninja_belts) -> int:
    """Calculate the amount of points rewarded on PyBites given the ninja_belts
    dictionary, formula: belt score x belt owners (aka ninjas) (of course there
    are more points but let's keep it simple)
    ...
    """
    return sum(stats.score * stats.ninjas for stats in belts.values())
